systemDictionary = {
    "OPC UA adapter settings": {"en": "OPC UA adapter settings",  "de": "OPC UA Adapter-Einstellungen",  "ru": "Настройки драйвера OPC UA"},
    ...
    "Divided by comma":       {
        "en": "Divided by comma, e.g. 'opcua/0/#,javascript/#'",
        "de": "Mit Komma getrennt, z.B 'opcua/0/#,javascript/#'",
        "ru": "Использовать запятую, как разделитеть. Например 'opcua/0/#,javascript/#'"
    },
    "Mask to publish":       {
        "en": "e.g. 'opcua.0.*,javascript.*'",
        "de": "z.B 'opcua.0.*,javascript.*'",
        "ru": "Использовать запятую, как разделитеть. Например 'opcua.0.*,javascript.*'"
    },
    "Store only on change:":  {"en": "Store/Send only on change:",  "de": "Speichern/Senden nur bei Änderung:",  "ru": "Сохранять/Отсылать только изменения:"},
    ...
    "Adapter settings":       {"en": "OPC UA settings",        "de": "OPC UA Einstellungen",     "ru": "Настройки OPC UA"},
    ...
    "Client":                 {"en": "Client",                  "de": "Client",                 "ru": "Клиент"}
};